...
#include "center/msg/detail/custom_unity__rosidl_typesupport_fastrtps_c.h"
...
using _CustomUnity__ros_msg_type = center__msg__CustomUnity;
...
size_t get_serialized_size_center__msg__CustomUnity(
  const void * untyped_ros_message,
...
static uint32_t _CustomUnity__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_center__msg__CustomUnity(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_center
size_t max_serialized_size_center__msg__CustomUnity(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _CustomUnity__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_center__msg__CustomUnity(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, center, msg, CustomUnity)() {
